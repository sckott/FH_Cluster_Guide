...
Our goal for this course is to get you running on the Fred Hutch cluster **quickly and efficiently**. This course is intended for anyone who may benefit from using the cluster, whether you're completely new to using a cluster, or are staff new to the Hutch who may have used a cluster at another institution. We hope that the following modules will help you take advantage of the powerful resources the Fred Hutch has to offer!
