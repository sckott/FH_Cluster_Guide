...
The Scientific Comupting Team (SciComp) tries to set users up ahead of time, especially if those users come from a compute-heavy lab group. However, not everyone is set up automatically. Please fill out [this Account Setup Form](https://forms.gle/5ct8mQCeBD7LUt6S7) and we will ensure you are set up correctly!
