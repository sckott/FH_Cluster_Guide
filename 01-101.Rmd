...
Note that it may take just a bit of time for SciComp to see your email request, but it is usually fairly quick! You will then receive an email back from the SciComp team that you now have cluster access.
