...
1. Click [here](https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html) to install the latest version of PuTTY. You will choose the 64-bit x86 installation with few exceptions.
    ...
    ```{r, echo=FALSE, fig.alt='The PuTTY latest version installation website.'}
...
1. You should then see PuTTY available in the Software Center. You might need to click "Install" finish the installation here.

    ```{r, echo=FALSE, fig.alt='The Software Center application lists available apps, including PuTTY.'}
ottrpal::include_slide("https://docs.google.com/presentation/d/1BQxrVYdKZTbpCaF-i_q9w7s9x034lEXpQZDU-Sl09cs/edit#slide=id.g15643d101eb_4_15")
    ...
    ```{r, echo=FALSE, fig.alt='The PuTTY page inside Software Center. The Install button is highlighted.'}
...
1. PuTTY should now be available in your applications. Click on PuTTY to open.
    ...
    ```{r, echo=FALSE, fig.alt='The PuTTY application now appears in the Windows app menu.'}
...
1. You should now see the PuTTY Configuration menu.
    ...
    ```{r, echo=FALSE, fig.alt='The PuTTY configuration menu is open.'}
...
1. Go to the PuTTY Configuration menu. Under "Host Name" type **rhino** and click "Open".
    ...
    ```{r, echo=FALSE, fig.alt='The PuTTY Host Name "rhino" has been typed in.'}
...
1. You will be prompted to login. Type in your HutchNetID (e.g., `jsmith3`).
    ...
    ```{r, echo=FALSE, fig.alt='The login prompt for rhino.'}
...
1. You are now logged in! There should be a login message, with your name at the bottom.
    ...
    ```{r, echo=FALSE, fig.alt='Screenshot of the PuTTY Terminal.'}
