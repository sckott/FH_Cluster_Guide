...
Finally, use the following command to submit the script and run the job. You should see a message like `Submitted batch job 12345678` (your number will vary). 
