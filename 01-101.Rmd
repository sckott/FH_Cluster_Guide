...
```{r, echo=FALSE, fig.alt='Screenshot of .', out.width = '100%'}
...
Right click on "`01.sh`" and select "Download". You will see a "Transfers" prompt open, and the "`01.sh`" file should now appear in your Downloads folder. Open the "`01.sh`" file.
...
Edit the message to your name and save the file. Rename the file "`01-name.sh`"
...
Return to your Terminal. Submit a job with your new script by running:
