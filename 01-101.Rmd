...
You should see the file `01.sh` in your home directory. The `.sh` ending means this is a script meant to run from the command line. Let's next inspect the script. 
...
Type `ls` again. You should now see a log file like `slurm-12345678.out`. Let's look at this file. We should see our message has been printed to the `.out` file!
