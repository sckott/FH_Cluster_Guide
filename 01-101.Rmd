...
```{r, echo=FALSE, fig.alt='SciComp self-service landing page with links.', out.width = '80%'}
...
```{r, echo=FALSE, fig.alt='The user has been set up correctly, indicated by cluster access: True.', out.width = '80%'}
...
```{r, echo=FALSE, fig.alt='The user has not been set up correctly, indicated by cluster access: False.', out.width = '80%'}
