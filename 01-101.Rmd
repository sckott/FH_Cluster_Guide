...
```{r, echo=FALSE, fig.alt='We are on the first step of the pathway.', out.width = '100%'}
...
```{r, echo=FALSE, fig.alt='We are on the second step of the pathway.', out.width = '100%'}
...
| `sbatch`   | a Slurm command which submits a script containing job instructions for the cluster | `sbatch [scriptname.sh]` |
