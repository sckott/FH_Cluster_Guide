...
\author{}
\date{\vspace{-2.5em}October 05, 2022}
...
Errors similar to this typically indicate that the account hasn't been set up by SciComp. This is a quick fix if you \href{01-101.html\#pi-account}{use the form mentioned in the course}.
