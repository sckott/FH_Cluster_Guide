...
\author{}
\date{\vspace{-2.5em}October 19, 2022}
...
Fred Hutch maintains a \href{https://en.wikipedia.org/wiki/HPCC}{high performance computing cluster} specifically to support research work that requires more intensive computing than your average desktop computer can handle.

Our goal for this course is to get you running on the Fred Hutch cluster \textbf{quickly and efficiently}. It is intended for everyone from brand new cluster users to researchers who have used a cluster at another institution but are new to Fred Hutch.
...
\tightlist
\item
  Go to the SciComp Self-Service Portal
\item
